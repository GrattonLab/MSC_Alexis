...
%tname=['~/Desktop/MSC_Alexis/analysis/output/results/MVPA_mat/between_sub_test/' task '_onlyGood_taskOnly_timesplit_acc.csv']
%writetable(t_tab, tname, 'WriteRowNames', true)

%r_tab=cell2table(R);
%r_tab.Properties.VariableNames=trainList;
%r_tab.Properties.RowNames=predictList;
%rname=['~/Desktop/MSC_Alexis/analysis/output/results/MVPA_mat/between_sub_test/' task '_onlyGood_restOnly_timesplit_acc.csv']
