function DS(task)
    ...
    %trainList={'MSC02','MSC04','MSC05'}; %timesplit data
    ...
    for i = 1:length(trainList)
        ...
        taskFC=['~/Desktop/MSC_Alexis/analysis/data/mvpa_data/' task '/' trainList{i} '_AllGlass_parcel_corrmat.mat'];
        %taskFC=['~/Desktop/MSC_Alexis/analysis/data/mvpa_data/' task '/' trainList{i} '_AllSemantic_parcel_corrmat.mat'];
        tFC=load(taskFC);
        ...
        %restFC=['~/Desktop/MSC_Alexis/analysis/data/mvpa_data/timeQuality_rest/' trainList{i} '_AllGlass_parcel_corrmat.mat'];
        ...
        %r.(trainList{i})=rFC.rest_glassFC;
    ...
    for i = 1:length(trainList)
        ...
        for j = 1:length(testsubs)
            ...
            saveName=[strcat('~/Desktop/MSC_Alexis/analysis/output/results/MVPA_mat/between_sub_test/results_mat/only_good/timeQuality_rest/mixedsplit_train_', trainsub, '_test_', testsub, 'AllGlass.mat')];
