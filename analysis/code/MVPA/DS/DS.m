function DS(task)
    ...
    for i = 1:length(trainList)
        ...
        for j = 1:length(testsubs)
            ...
            saveName=[strcat('~/Desktop/MSC_Alexis/analysis/output/results/MVPA_mat/between_sub_test/results_mat/only_good/timeQuality_rest/train_', trainsub, '_test_', testsub, 'AllSemantic.mat')];
