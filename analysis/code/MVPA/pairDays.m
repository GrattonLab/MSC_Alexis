function pairDays(sub)
    ...
    motorFC=['~/Desktop/MSC_Alexis/analysis/data/mvpa_data/motor/corrmats_timesplit/' sub '_thirds_parcel_corrmat.mat'];
    ...
    memoryFC=['~/Desktop/MSC_Alexis/analysis/data/mvpa_data/mem/corrmats_timesplit/' sub '_thirds_parcel_corrmat.mat'];
    ...
    GlassmixedFC=['~/Desktop/MSC_Alexis/analysis/data/mvpa_data/mixed/corrmats_timesplit/' sub '_thirds_AllGlass_parcel_corrmat.mat'];
    ...
    SemmixedFC=['~/Desktop/MSC_Alexis/analysis/data/mvpa_data/mixed/corrmats_timesplit/' sub '_thirds_AllSemantic_parcel_corrmat.mat'];
    ...
    restFC=['~/Desktop/MSC_Alexis/analysis/data/mvpa_data/rest/corrmats_timesplit/' sub '_thirds_parcel_corrmat.mat'];
    ...
    for i=1:length(taskList)
        ...
        saveName=[strcat('~/Desktop/MSC_Alexis/analysis/output/results/MVPA_mat/LO1DAY/timesplit_mat/thirds_', taskListNames{i}, sub, '.mat')]
