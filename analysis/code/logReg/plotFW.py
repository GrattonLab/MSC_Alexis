...
def feature_plots(coef, f='DS', task='task', sub='i'):
    ...
    fig.savefig("/Users/aporter1350/Desktop/MSC_Alexis/analysis/output/images/logReg/fw/" +f+ "/" +task+ "_" +sub+ ".png", bbox_inches='tight')
...
def saveFW(coef, f, task, sub):
    ...
    df.to_csv("/Users/aporter1350/Desktop/MSC_Alexis/analysis/output/results/logReg/fw/" +f+ "/" +task+ "_" +sub+ ".csv")
