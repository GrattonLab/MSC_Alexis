...
nsamples=10;
for day=1:nsamples
    cell02{day}=mem02.parcel_time{day}(logical(mem02.tmask_all{day}),:); 
    cell04{day}=mem04.parcel_time{day}(logical(mem04.tmask_all{day}),:); 
    cell05{day}=mem05.parcel_time{day}(logical(mem05.tmask_all{day}),:); 
    cell07{day}=mem07.parcel_time{day}(logical(mem07.tmask_all{day}),:); 
end
